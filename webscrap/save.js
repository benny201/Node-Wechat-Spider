...
var baseUrl = "http://chuansong.me/account/gushequ?start=0";  //迅雷首页链接
...
function getAllMovieLink($){
	...
	for(var i=1;i<10;i++){
		var url='http://chuansong.me'+linkElem.eq(i).attr('href');
		// 注意去重
...
function getDownloadLink($,callback){
	var downLink=$('.rich_media_content');
	var movieName=$('.rich_media_title').text();
	var obj={
		'downLink':downLink,
		'movieName':movieName
	};
